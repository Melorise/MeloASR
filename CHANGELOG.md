...
- 修复快速松开快捷键时，网页尚未完成异步启动便再次点击麦克风，导致外部会话已结束但网页仍在录音的问题。

## [1.0.1] - 2026-09-01

### 变更

- 重新设计设置界面，统一 TamaASR 品牌色、控件层级、服务状态、快捷键、开关与即时保存反馈。
- 改进悬浮球位置调整页，增加桌面预览、九宫格选中状态、精确坐标与方向微调控件。
- 补充键盘焦点、辅助文本、减少动态效果偏好和窄窗口布局支持。
